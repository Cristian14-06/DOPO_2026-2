...
public class Wheel {
    ...
    public void spin(int steps) {
        ...
        if (steps < 0) {
            JOptionPane.showMessageDialog(null, "El número de pasos no puede ser negativo.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        currentSymbol = (currentSymbol + steps) % symbols.size();
        refresh();
    }
